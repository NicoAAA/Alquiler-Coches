...
export interface ApiMetodoMetodo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Metodo_de_Pago: Schema.Attribute.Enumeration<
      [
        'Efectivo',
        'Tarjeta de Debito',
        'Tarjeta de Credito',
...
export interface ApiTipoTipo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    costo_alquiler: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion_ampliada: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
        minLength: 2;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tipo.tipo'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tipo_vehiculo: Schema.Attribute.Enumeration<
      [
        'Sedan',
        'Camioneta',
        'SUV',
